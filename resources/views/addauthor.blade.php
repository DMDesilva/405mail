...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Author Registration Form</h4>
                    <h6 class="card-subtitle">Fill this form with correct details.</h6>
                    <form class="form p-t-20" method="post" action="/saveauthor">
                    {{csrf_field()}}
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <input type="text" id="authorid" name="authorid" class="form-control" placeholder="Author Id">
