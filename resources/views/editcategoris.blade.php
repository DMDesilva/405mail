...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Edit Category Details</h3>
            <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form p-t-20" method="POST" action="/categorydetailedit/{{$addcategory->id}}">
                   {{csrf_field()}}
                   {{method_field('PUT')}}
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="firstName" class="form-control"  value="{{$addcategory->category}}" name="category" placeholder="Category name">
                                    </div>
