        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form p-t-20" method="post" action="/save_rack">
                    {{csrf_field()}}
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="control-label">Rack Name</label>
                                    <input type="text" id="rack" name="rack" class="form-control" placeholder="Rack name">
                                    <small class="form-control-feedback"> Enter Rack Name </small> </div>

                                <div class="form-group">
                                    <label class="control-label">Rack Id</label>
                                    <input type="text" id="rackid" name="rackid" class="form-control" placeholder="Rack Id">
