...
<head>
    ...
    <link href="{{asset('material-pro/assets/plugins/css-chart/css-chart.css')}}" rel="stylesheet">
    <!--This page css - Morris CSS -->
    <link href="{{asset('material-pro/assets/plugins/c3-master/c3.min.css')}}" rel="stylesheet">
    <!-- Vector CSS -->
    <link href="{{asset('material-pro/assets/plugins/vectormap/jquery-jvectormap-2.0.2.css')}}" rel="stylesheet" />
    <!-- Custom CSS -->
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <span>
                         ...
                         <!-- Light Logo text -->    
                         <img src="{{asset('material-pro/assets/images/logo-light-text.png')}}" class="light-logo" alt="homepage" /></span> </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                <!-- ============================================================== -->
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0">
                        <!-- This is  -->
                        <li class="nav-item"> <a class="nav-link nav-toggler hidden-md-up text-muted waves-effect waves-dark" href="{{asset('material-pro/material/javascript:void(0)')}}"><i class="mdi mdi-menu"></i></a> </li>
                        <li class="nav-item"> <a class="nav-link sidebartoggler hidden-sm-down text-muted waves-effect waves-dark" href="{{asset('material-pro/material/javascript:void(0)')}}"><i class="ti-menu"></i></a> </li>
                        <!-- ============================================================== -->
                        <!-- Search -->
                        <!-- ============================================================== -->
                        <li class="nav-item hidden-sm-down search-box">
                            <a class="nav-link hidden-sm-down text-muted waves-effect waves-dark" href="{{asset('material-pro/material/javascript:void(0)')}}"><i class="ti-search"></i></a>
                                ...
                                <ul class="mega-dropdown-menu row">
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container"> <img class="d-block img-fluid" src="{{asset('material-pro/assets/images/big/img1.jpg')}}" alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="{{asset('material-pro/assets/images/big/img2.jpg')}}" alt="Second slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="{{asset('material-pro/assets/images/big/img3.jpg')}}" alt="Third slide"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div id="accordion" class="nav-accordion" role="tablist" aria-multiselectable="true">
                                            ...
                                            <div class="card">
                                                <div class="card-header" role="tab" id="headingTwo">
                                                    <h5 class="mb-0">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="{{asset('material-pro/material/#collapseTwo')}}" aria-expanded="false" aria-controls="collapseTwo">
                                            ...
                                            <div class="card">
                                                <div class="card-header" role="tab" id="headingThree">
                                                    <h5 class="mb-0">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="{{asset('material-pro/material/#collapseThree')}}" aria-expanded="false" aria-controls="collapseThree">
                                    ...
                                    <li class="col-lg-3 col-xlg-4 m-b-30">
                                        ...
                                        <ul class="list-style-none">
                                            <li><a href="{{asset('material-pro/material/javascript:void(0)')}}"><i class="fa fa-check text-success"></i> You can give link</a></li>
                                            <li><a href="{{asset('material-pro/material/javascript:void(0)')}}"><i class="fa fa-check text-success"></i> Give link</a></li>
                                            <li><a href="{{asset('material-pro/material/javascript:void(0)')}}"><i class="fa fa-check text-success"></i> Another Give link</a></li>
                                            <li><a href="{{asset('material-pro/material/javascript:void(0)')}}"><i class="fa fa-check text-success"></i> Forth link</a></li>
                                            <li><a href="{{asset('material-pro/material/javascript:void(0)')}}"><i class="fa fa-check text-success"></i> Another fifth link</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right mailbox scale-up">
                                <ul>
                                    ...
                                    <li>
                                        <a class="nav-link text-center" href="{{asset('material-pro/material/javascript:void(0);')}}"> <strong>Check all notifications</strong> <i class="fa fa-angle-right"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="{{asset('material-pro/assets/images/users/1.jpg')}}" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Pavan kumar</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:30 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="{{asset('material-pro/assets/images/users/2.jpg')}}" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Sonu Nigam</h5> <span class="mail-desc">I've sung a song! See you at</span> <span class="time">9:10 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="{{asset('material-pro/assets/images/users/3.jpg')}}" alt="user" class="img-circle"> <span class="profile-status away pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Arijit Sinh</h5> <span class="mail-desc">I am a singer!</span> <span class="time">9:08 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="{{asset('material-pro/assets/images/users/4.jpg')}}" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Pavan kumar</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:02 AM</span> </div>
                                            </a>
                                        </div>
                                    ...
                                    <li>
                                        <a class="nav-link text-center" href="{{asset('material-pro/material/javascript:void(0);')}}"> <strong>See all e-Mails</strong> <i class="fa fa-angle-right"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                ...
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            ...
                                            <div class="u-text">
                                                <h4>Steave Jobs</h4>
                                                <p class="text-muted">varun@gmail.com</p><a href="{{asset('material-pro/material/profile.html')}}" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                                        </div>
                                    </li>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                <!-- User profile -->{{asset('material-pro/assets/images/users/profile.png')}}
